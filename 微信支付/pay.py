from common.paykeys import client_appid, client_secret, Mch_id, Mch_key
import hashlib
import datetime
...
# 生成商品订单号
def getWxPayOrdrID():
    payOrdrID = Order.objects.get().order_number
    print(payOrdrID)
...
def get_bodyData(openid, client_ip, price):
    body = 'Mytest'  # 商品描述
    notify_url = 'https://cms-xinlixue.bnuonline.com/'  # 支付成功的回调地址  可访问 不带参数
